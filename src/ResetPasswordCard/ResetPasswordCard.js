    ...
    if (userDetails.password !== userDetails.confirmPassword) {
      ...
      try {
        ...
        let res = await axios.put(
          `${process.env.REACT_APP_MY_ENV}/reset-password`,
          {
  ...
  return (
    <Fragment>
      ...
      <div>
        ...
        <form className="form">
          <small>
            Hey <span className="text-primary">{userDetails.name}</span>, please
            reset your password
          </small>
          <div className="user-details mt-1">
            <small className="text-success">New Password</small>
            <input
              type="password"
              name="password"
